...
void VoronoiDiagramGenerator::pushGraphEdge(float x1, float y1, float x2, float y2, int nbr1, int nbr2)
{
	...
	newEdge->x2 = x2;
	newEdge->y2 = y2;
	newEdge->sitenbr1 = nbr1;
	newEdge->sitenbr2 = nbr2;
}
...
void VoronoiDiagramGenerator::line(float x1, float y1, float x2, float y2, int nbr1, int nbr2)
{	
	pushGraphEdge(x1,y1,x2,y2, nbr1,nbr2);
